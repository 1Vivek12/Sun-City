...
const DEPT_STYLES: Record<string, { gradient: string; accent: string; icon: string }> = {
  ...
  'Obstetrics & Gynecology':     { gradient: 'from-rose-500 via-pink-500 to-fuchsia-500', accent: 'text-rose-600 bg-rose-50 border-rose-200', icon: '🩺' },
  ...
  'Gastroenterology':            { gradient: 'from-orange-500 via-amber-500 to-yellow-500', accent: 'text-orange-600 bg-orange-50 border-orange-200', icon: '🫄' },
  'ENT (Ear, Nose & Throat)':   { gradient: 'from-cyan-500 via-sky-500 to-blue-500', accent: 'text-cyan-600 bg-cyan-50 border-cyan-200', icon: '👂' },
  'General Medicine':            { gradient: 'from-slate-600 via-gray-500 to-zinc-500', accent: 'text-slate-600 bg-slate-50 border-slate-200', icon: '💊' },
  'Medicine':                    { gradient: 'from-slate-600 via-gray-500 to-zinc-500', accent: 'text-slate-600 bg-slate-50 border-slate-200', icon: '💊' },
  'Pulmonology / Chest Medicine':{ gradient: 'from-teal-600 via-cyan-600 to-blue-600', accent: 'text-teal-600 bg-teal-50 border-teal-200', icon: '🫁' },
  'Pathology':                   { gradient: 'from-purple-600 via-indigo-500 to-blue-600', accent: 'text-purple-600 bg-purple-50 border-purple-200', icon: '🧪' },
  ...
  'Facial Surgery / Cosmetology':{ gradient: 'from-pink-500 via-fuchsia-500 to-purple-500', accent: 'text-pink-600 bg-pink-50 border-pink-200', icon: '💆' },
